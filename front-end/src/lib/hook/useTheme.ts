...
const DEFAULT_THEME_OPTIONS: ThemeOptions = {
  ...
  palette: {
    ...
    grey: {
      50: twTheme.colors.slate[50],
      100: twTheme.colors.slate[100],
      200: twTheme.colors.slate[200],
      300: twTheme.colors.slate[300],
      400: twTheme.colors.slate[400],
      500: twTheme.colors.slate[500],
      600: twTheme.colors.slate[600],
      700: twTheme.colors.slate[700],
      800: twTheme.colors.slate[800],
      900: twTheme.colors.slate[900],
    },
  },
  typography: {
...
const useTheme = () => {
  const theme = useMemo(() => DEFAULT_THEME_OPTIONS, []);
